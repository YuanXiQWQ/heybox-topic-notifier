...
旧账号密码兼容逻辑的迁移检查说明见
[docs/zh-CN/auth-migration.md](docs/zh-CN/auth-migration.md)。
...
again; use it with care in production. The legacy password compatibility check
is documented in [docs/zh-CN/auth-migration.md](docs/zh-CN/auth-migration.md).
