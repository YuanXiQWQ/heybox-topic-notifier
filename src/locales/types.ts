...
export type Messages = {
  ...
  accountEmail: string;
  accountEmailCode: string;
  accountEmailCodeFailed: string;
  accountEmailCodeInvalid: string;
  accountEmailCodeRequired: string;
  accountEmailCodeSent: string;
  accountEmailInvalid: string;
  accountEmailNoVerified: string;
  accountEmailSendCode: string;
  accountEmailSendingCode: string;
  accountEmailSettings: string;
  accountEmailTwoFactorAvailable: string;
  accountEmailUpdated: string;
  ...
  accountGoogleAlreadyBound: string;
  accountGoogleBind: string;
  accountGoogleBindFailed: string;
  accountGoogleBinding: string;
  accountGoogleBound: string;
  accountGoogleBoundEmail: string;
  accountGoogleConflict: string;
  accountGoogleNotBound: string;
  accountGoogleUnavailable: string;
  accountGoogleUnbind: string;
  accountGoogleUnbound: string;
  accountLoginMethods: string;
  ...
  accountPasswordConfigured: string;
  accountPasswordNotConfigured: string;
  accountPasswordVerified: string;
  accountPasswordVerificationRequired: string;
  accountPasskeyAdd: string;
  accountPasskeyBind: string;
  accountPasskeyBindFailed: string;
  accountPasskeyBinding: string;
  accountPasskeyBound: string;
  accountPasskeyBoundCount: string;
  accountPasskeyCreatedAt: string;
  accountPasskeyCredentials: string;
  accountPasskeyDelete: string;
  accountPasskeyDeleted: string;
  accountPasskeyLabel: string;
  accountPasskeyLabelPlaceholder: string;
  accountPasskeyLastUsedAt: string;
  accountPasskeyNeverUsed: string;
  accountPasskeyNoCredentials: string;
  accountPasskeyNotFound: string;
  ...
  accountReauthRequired: string;
  accountReauthSettings: string;
  accountReauthStatus: string;
  accountReauthUnavailable: string;
  accountReauthVerified: string;
  accountReauthVerify: string;
  accountRecoveryCodes: string;
  accountRecoveryCodesCount: string;
  accountRecoveryCodesDownload: string;
  accountRecoveryCodesDownloadFailed: string;
  accountRecoveryCodesGenerate: string;
  accountRecoveryCodesGenerateFailed: string;
  accountRecoveryCodesGenerateIntro: string;
  accountRecoveryCodesGenerating: string;
  accountRecoveryCodesHashedOnly: string;
  accountRecoveryCodesNewIntro: string;
  accountRecoveryCodesRegenerate: string;
  accountRecoveryCodesRegenerateIntro: string;
  accountRecoveryCodesRegenerating: string;
  accountRecoveryCodesSaveHint: string;
  accountRecoveryCodesUnavailable: string;
  accountRecoveryCodesView: string;
  accountSave: string;
  accountSettings: string;
  accountTotpAlreadyBound: string;
  accountTotpBind: string;
  accountTotpBound: string;
  accountTotpBoundCount: string;
  accountTotpCode: string;
  accountTotpConfigMissing: string;
  accountTotpCopyFailed: string;
  accountTotpCopyKey: string;
  accountTotpCopySuccess: string;
  accountTotpCredentials: string;
  accountTotpDelete: string;
  accountTotpDeleted: string;
  accountTotpInvalid: string;
  accountTotpLabel: string;
  accountTotpLabelPlaceholder: string;
  accountTotpManualKey: string;
  accountTotpNoCredentials: string;
  accountTotpNotBound: string;
  accountTotpNotFound: string;
  accountTotpQrCode: string;
  accountTotpSettings: string;
  accountTotpSetupIntro: string;
  accountTotpStatus: string;
  accountTotpUpdated: string;
  accountTotpVerify: string;
  ...
  accountTwoFactorToggle: string;
  accountTwoFactorUnavailable: string;
  accountTwoFactorUpdated: string;
  accountTwoStepSettings: string;
  accountUpdated: string;
  accountUseCurrentPassword: string;
  ...
  authOtherLoginMethods: string;
  authUseEmailCodeLogin: string;
  authUsePasswordLogin: string;
