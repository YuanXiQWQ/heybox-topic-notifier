...
const materialSymbolPaths: Record<MaterialSymbolName, string> = {
  ...
  timer:
    "M360-840v-80h240v80H360Zm80 440h80v-240h-80v240Zm40 320q-74 0-139.5-28.5T226-186q-49-49-77.5-114.5T120-440q0-74 28.5-139.5T226-694q49-49 114.5-77.5T480-800q62 0 119 20t107 58l56-56 56 56-56 56q38 50 58 107t20 119q0 74-28.5 139.5T734-186q-49 49-114.5 77.5T480-80Zm0-80q116 0 198-82t82-198q0-116-82-198t-198-82q-116 0-198 82t-82 198q0 116 82 198t198 82Zm0-280Z",
  toggle_on:
  ...
  upload:
    "M440-800v353L336-551l-56 57 200 200 200-200-56-57-104 104v-353h-80ZM240-160q-33 0-56.5-23.5T160-240v-120h80v120h480v-120h80v120q0 33-23.5 56.5T720-160H240Z",
  webhook:
...
const authIconContents: Record<Exclude<AuthIconName, "google">, string> = {
  avatar: `
    ...
    <path d="M6.5 18a6.3 6.3 0 0 1 11 0"></path>
  `,
  authenticator: `
...
export function dashboardIcon(
  ...
  return strokedIcon(
    ...
    <rect x="13" y="4" width="7" height="10" rx="1.5"></rect>
...
export function settingsIcon(
  ...
  return strokedIcon(
    ...
    <path d="M18.5 7H20"></path>
    <path d="M4 17h1.5"></path>
...
/**
 * 渲染 Material Symbols 的翻译语言图标。
 *
 * @param className 图标 CSS 类名。
 * @return SVG 图标 HTML。
 */
export function languageTextIcon(className = "ui-icon"): string {
  return materialSymbolIcon("translate", className);
}
