...
>
  <head>
    ...
    <link rel="stylesheet" href="/static/fun/lobotomy-corp/lobotomy-corp.css?v=20260912-plague-doctor-17">
    ${stylesheetHtml}
    ...
    <script type="module" src="/static/fun/lobotomy-corp/lobotomy-corp.js?v=20260912-plague-doctor-17"></script>
    ${renderMatchTableRowLinkStyle()}
  </head>
  <body>
    <header class="topbar">
