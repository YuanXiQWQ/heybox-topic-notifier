...
>
  <head>
    ...
    <link rel="stylesheet" href="/static/fun/lobotomy-corp/lobotomy-corp.css?v=20260913-dont-touch-me-shutdown-1">
    ${stylesheetHtml}
    ...
    <script type="module" src="/static/fun/lobotomy-corp/lobotomy-corp.js?v=20260913-dont-touch-me-shutdown-1"></script>
    ${renderMatchTableRowLinkStyle()}
  </head>
  <body>
    <header class="topbar">
