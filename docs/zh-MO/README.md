...
- 儀表板：查看輪詢狀態、累計命中數、最近一次命中和待處理命中，並可手動觸發檢查
...
- 通知通道：支援自訂 Webhook、Server酱、PushPlus、WxPusher、郵件 API 和 SMTP
- 通知中轉：可使用倉庫內的 Cloudflare Worker 中轉 PushPlus、WxPusher 和 Server酱
