...
- `main`: استقرار انتشار رسمی، مسیریابی‌شده به Production URL
- `dev`: استقرار آزمایشی پیش از انتشار، مسیریابی‌شده به Git Branch / DEV URL
...
- allowlist امنیتی خروجی: `OUTBOUND_ALLOWED_HOSTS`
