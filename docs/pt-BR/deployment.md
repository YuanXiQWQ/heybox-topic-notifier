...
- Valores padrão básicos: `APP_LOCALE`, `HEYBOX_TOPIC_ID`, `NOTIFIER_PROVIDER`
...
Contas novas começam com o polling desativado e só buscam dados depois de ativar “Enable polling” na própria página de configurações.
